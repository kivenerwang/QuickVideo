...
//                libLoader.loadLibrary(CompatBrowser.getInstance().getPlayerSoLoader().getLibPath() + "/libijkffmpeg.so");
//
//
//                libLoader.loadLibrary(CompatBrowser.getInstance().getPlayerSoLoader().getLibPath() + "/libijksdl.so");
//
//                libLoader.loadLibrary(CompatBrowser.getInstance().getPlayerSoLoader().getLibPath() + "/libijkplayer.so");
    ...
    /**
     * Sets the tv.danmaku.ijk.media.player to be looping or non-looping.
     *
